...
use mlscraper_rust::selectors::{Selector, SelectorFuzzer, SelectorPart};
...
fn generate<R: Rng>(
    ...
    fuzzer.random_selector_for_node(target, root, parser, retries, rng)
}
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_with_input(
        BenchmarkId::new("generate", "benches/match6481506591.html"),
        &args,
        |b, input| {
